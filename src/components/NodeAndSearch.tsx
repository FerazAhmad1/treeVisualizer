...
const NodeAndSearch: React.FC<TreeViewProps> = ({ jsonInput }) => {
  ...
  const searchHandler = useCallback(
    ...
    [nodes, originalNodes, setCenter, fitView]
  );

  return (
    <div className="flex flex-1 flex-col">
      <div className="flex-1">
        <SearchBox buttonClicHandler={searchHandler} />
        <TreeView
          nodes={nodes}
          edges={edges}
